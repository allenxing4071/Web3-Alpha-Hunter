...
export default function DatabasePage() {
  ...
  const tabs = [
    ...
    { id: 'projects_pending', label: '⏳ projects_pending', name: 'projects_pending', desc: 'AI推荐的待审核项目' },
    { id: 'social_metrics', label: '📱 social_metrics', name: 'social_metrics', desc: '社交媒体数据指标' },
    { id: 'onchain_metrics', label: '⛓️ onchain_metrics', name: 'onchain_metrics', desc: '区块链上的实际数据' },
    { id: 'ai_analysis', label: '🤖 ai_analysis', name: 'ai_analysis', desc: 'AI智能分析结果' },
    { id: 'ai_configs', label: '🔑 ai_configs', name: 'ai_configs', desc: 'AI模型配置' },
    { id: 'ai_work_config', label: '🧠 ai_work_config', name: 'ai_work_config', desc: 'AI智能助理工作参数' },
    { id: 'ai_learning_feedback', label: '📚 ai_learning_feedback', name: 'ai_learning_feedback', desc: 'AI学习反馈记录' },
    { id: 'token_launch_predictions', label: '🚀 token_launch_predictions', name: 'token_launch_predictions', desc: '代币发行预测' },
    { id: 'airdrop_value_estimates', label: '💰 airdrop_value_estimates', name: 'airdrop_value_estimates', desc: '空投价值估算' },
    { id: 'investment_action_plans', label: '📋 investment_action_plans', name: 'investment_action_plans', desc: '投资行动计划' },
    { id: 'project_discoveries', label: '🔍 project_discoveries', name: 'project_discoveries', desc: '多平台项目热度追踪' },
    { id: 'kols', label: '👤 kols', name: 'kols', desc: 'KOL数据和表现追踪' },
    { id: 'kols_pending', label: '👥 kols_pending', name: 'kols_pending', desc: 'AI推荐的待审核KOL' },
    { id: 'kol_performances', label: '📈 kol_performances', name: 'kol_performances', desc: 'KOL历史表现追踪' },
    { id: 'platform_search_rules', label: '🌍 platform_search_rules', name: 'platform_search_rules', desc: '平台搜索规则配置' },
    { id: 'twitter_keywords', label: '🐦 twitter_keywords', name: 'twitter_keywords', desc: 'Twitter搜索关键词库' },
    { id: 'telegram_channels', label: '💬 telegram_channels', name: 'telegram_channels', desc: 'Telegram监控频道列表' },
    { id: 'discord_servers', label: '🎮 discord_servers', name: 'discord_servers', desc: 'Discord监控服务器列表' },
    { id: 'platform_daily_stats', label: '📊 platform_daily_stats', name: 'platform_daily_stats', desc: '平台每日数据统计' },
  ]
