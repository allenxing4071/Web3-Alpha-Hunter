...
export default function DatabasePage() {
  ...
  const tabs = [
    ...
    { id: 'platform_search_rules', label: '🌍 Platform Rules', name: 'Platform Search Rules (平台规则)', desc: '平台搜索规则配置' },
    { id: 'twitter_keywords', label: '🐦 Twitter Keywords', name: 'Twitter Keywords (Twitter关键词)', desc: 'Twitter搜索关键词库' },
    { id: 'telegram_channels', label: '💬 Telegram Channels', name: 'Telegram Channels (Telegram频道)', desc: 'Telegram监控频道列表' },
    { id: 'discord_servers', label: '🎮 Discord Servers', name: 'Discord Servers (Discord服务器)', desc: 'Discord监控服务器列表' },
    { id: 'platform_daily_stats', label: '📊 Platform Stats', name: 'Platform Daily Stats (平台统计)', desc: '平台每日数据统计' },
  ]
