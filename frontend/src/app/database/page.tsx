...
export default function DatabasePage() {
  ...
  const tabs = [
    { id: 'projects', label: '📊 projects (项目表)', name: 'projects (项目表)', desc: '存储Web3项目的完整数据库，评分集结仓' },
    { id: 'projects_pending', label: '⏳ projects_pending (待审核)', name: 'projects_pending (待审核)', desc: 'AI推荐的待审核项目' },
    { id: 'social_metrics', label: '📱 social_metrics (社交指标)', name: 'social_metrics (社交指标)', desc: '社交媒体数据指标' },
    { id: 'onchain_metrics', label: '⛓️ onchain_metrics (链上数据)', name: 'onchain_metrics (链上数据)', desc: '区块链上的实际数据' },
    { id: 'ai_analysis', label: '🤖 ai_analysis (AI分析)', name: 'ai_analysis (AI分析)', desc: 'AI智能分析结果' },
    { id: 'ai_configs', label: '🔑 ai_configs (AI配置)', name: 'ai_configs (AI配置)', desc: 'AI模型配置' },
    { id: 'ai_work_config', label: '🧠 ai_work_config (工作配置)', name: 'ai_work_config (工作配置)', desc: 'AI智能助理工作参数' },
    { id: 'ai_learning_feedback', label: '📚 ai_learning_feedback (学习反馈)', name: 'ai_learning_feedback (学习反馈)', desc: 'AI学习反馈记录' },
    { id: 'token_launch_predictions', label: '🚀 token_launch_predictions (发币预测)', name: 'token_launch_predictions (发币预测)', desc: '代币发行预测' },
    { id: 'airdrop_value_estimates', label: '💰 airdrop_value_estimates (空投估算)', name: 'airdrop_value_estimates (空投估算)', desc: '空投价值估算' },
    { id: 'investment_action_plans', label: '📋 investment_action_plans (行动计划)', name: 'investment_action_plans (行动计划)', desc: '投资行动计划' },
    { id: 'project_discoveries', label: '🔍 project_discoveries (项目发现)', name: 'project_discoveries (项目发现)', desc: '多平台项目热度追踪' },
    { id: 'kols', label: '👤 kols (KOL列表)', name: 'kols (KOL列表)', desc: 'KOL数据和表现追踪' },
    { id: 'kols_pending', label: '👥 kols_pending (KOL待审核)', name: 'kols_pending (KOL待审核)', desc: 'AI推荐的待审核KOL' },
    { id: 'kol_performances', label: '📈 kol_performances (KOL表现)', name: 'kol_performances (KOL表现)', desc: 'KOL历史表现追踪' },
    { id: 'platform_search_rules', label: '🌍 platform_search_rules (平台规则)', name: 'platform_search_rules (平台规则)', desc: '平台搜索规则配置' },
    { id: 'twitter_keywords', label: '🐦 twitter_keywords (关键词)', name: 'twitter_keywords (关键词)', desc: 'Twitter搜索关键词库' },
    { id: 'telegram_channels', label: '💬 telegram_channels (频道)', name: 'telegram_channels (频道)', desc: 'Telegram监控频道列表' },
    { id: 'discord_servers', label: '🎮 discord_servers (服务器)', name: 'discord_servers (服务器)', desc: 'Discord监控服务器列表' },
    { id: 'platform_daily_stats', label: '📊 platform_daily_stats (平台统计)', name: 'platform_daily_stats (平台统计)', desc: '平台每日数据统计' },
  ]
