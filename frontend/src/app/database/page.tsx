...
export default function DatabasePage() {
  ...
  const tabs = [
    { id: 'projects', label: '📊 Projects (项目表)', name: 'Projects - 项目主表', desc: '存储Web3项目的完整数据库，评分集结仓' },
    { id: 'projects_pending', label: '⏳ Projects Pending (待审核)', name: 'Projects Pending (待审核)', desc: 'AI推荐的待审核项目' },
    { id: 'social_metrics', label: '📱 Social Metrics (社交指标)', name: 'Social Metrics (社交指标)', desc: '社交媒体数据指标' },
    { id: 'onchain_metrics', label: '⛓️ Onchain Metrics (链上数据)', name: 'Onchain Metrics (链上数据)', desc: '区块链上的实际数据' },
    { id: 'ai_analysis', label: '🤖 AI Analysis (AI分析)', name: 'AI Analysis (AI分析)', desc: 'AI智能分析结果' },
    { id: 'ai_configs', label: '🔑 AI Config (AI配置)', name: 'AI Configs (AI配置)', desc: 'AI模型配置' },
    { id: 'ai_work_config', label: '🧠 AI Work Config (工作配置)', name: 'AI Work Config (AI工作配置)', desc: 'AI智能助理工作参数' },
    { id: 'ai_learning_feedback', label: '📚 AI Learning (AI学习)', name: 'AI Learning Feedback (AI学习)', desc: 'AI学习反馈记录' },
    { id: 'token_launch_predictions', label: '🚀 Token Launch Predictions (发币预测)', name: 'Token Launch Predictions (发币预测)', desc: '代币发行预测' },
    { id: 'airdrop_value_estimates', label: '💰 Airdrop Value Estimates (空投估算)', name: 'Airdrop Value Estimates (空投估算)', desc: '空投价值估算' },
    { id: 'investment_action_plans', label: '📋 Investment Action Plans (行动计划)', name: 'Investment Action Plans (行动计划)', desc: '投资行动计划' },
    { id: 'project_discoveries', label: '🔍 Project Discoveries (项目发现)', name: 'Project Discoveries (项目发现)', desc: '多平台项目热度追踪' },
    { id: 'kols', label: '👤 KOLs (关键意见领袖)', name: 'KOLs (关键意见领袖)', desc: 'KOL数据和表现追踪' },
    { id: 'kols_pending', label: '👥 KOLs Pending (待审核KOL)', name: 'KOLs Pending (待审核KOL)', desc: 'AI推荐的待审核KOL' },
    { id: 'kol_performances', label: '📈 KOL Performance (KOL表现)', name: 'KOL Performances (KOL表现)', desc: 'KOL历史表现追踪' },
    { id: 'platform_search_rules', label: '🌍 Platform Rules (平台规则)', name: 'Platform Search Rules (平台规则)', desc: '平台搜索规则配置' },
    { id: 'twitter_keywords', label: '🐦 Twitter Keywords (关键词)', name: 'Twitter Keywords (Twitter关键词)', desc: 'Twitter搜索关键词库' },
    { id: 'telegram_channels', label: '💬 Telegram Channels (频道)', name: 'Telegram Channels (Telegram频道)', desc: 'Telegram监控频道列表' },
    { id: 'discord_servers', label: '🎮 Discord Servers (服务器)', name: 'Discord Servers (Discord服务器)', desc: 'Discord监控服务器列表' },
    { id: 'platform_daily_stats', label: '📊 Platform Stats (平台统计)', name: 'Platform Daily Stats (平台统计)', desc: '平台每日数据统计' },
  ]
