...
export default function DatabasePage() {
  ...
  const tabs = [
    ...
    { id: 'projects_pending', label: '⏳ projects_pending', name: 'projects_pending (待审核项目)', desc: 'AI推荐的待审核项目' },
    ...
    { id: 'ai_work_config', label: '🧠 ai_work_config', name: 'ai_work_config (AI工作配置)', desc: 'AI智能助理工作参数' },
    { id: 'ai_learning_feedback', label: '📚 ai_learning_feedback', name: 'ai_learning_feedback (AI学习反馈)', desc: 'AI学习反馈记录' },
    ...
    { id: 'investment_action_plans', label: '📋 investment_action_plans', name: 'investment_action_plans (行动计划)', desc: '投资行动计划' },
    { id: 'project_discoveries', label: '🔍 project_discoveries', name: 'project_discoveries (项目发现)', desc: '多平台项目热度追踪' },
    { id: 'kols', label: '👤 kols', name: 'kols (KOL列表)', desc: 'KOL数据和表现追踪' },
    { id: 'kols_pending', label: '👥 kols_pending', name: 'kols_pending (待审核KOL)', desc: 'AI推荐的待审核KOL' },
    { id: 'kol_performances', label: '📈 kol_performances', name: 'kol_performances (KOL表现)', desc: 'KOL历史表现追踪' },
    { id: 'platform_search_rules', label: '🌍 platform_search_rules', name: 'platform_search_rules (平台规则)', desc: '平台搜索规则配置' },
    { id: 'twitter_keywords', label: '🐦 twitter_keywords', name: 'twitter_keywords (关键词)', desc: 'Twitter搜索关键词库' },
    { id: 'telegram_channels', label: '💬 telegram_channels', name: 'telegram_channels (频道列表)', desc: 'Telegram监控频道列表' },
    { id: 'discord_servers', label: '🎮 discord_servers', name: 'discord_servers (服务器列表)', desc: 'Discord监控服务器列表' },
    { id: 'platform_daily_stats', label: '📊 platform_daily_stats', name: 'platform_daily_stats (平台统计)', desc: '平台每日数据统计' },
  ]
